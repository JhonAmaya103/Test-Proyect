...
export class ListasService {
  ...
  private juegos: Juegos[] = [
    ...
    { id: 6, nombre: 'Spyro', categoriaId: 2, imagen: 'assets/imagenes/Spyro.jpg', precio: 30000, descripcion: 'Popular serie de videojuegos de plataformas, conocido por su valentía, testarudez y habilidades para embestir, planear y escupir fuego' },
    //Estrategia 
